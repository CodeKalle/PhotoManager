 ...
 * @date 21.11.2015 by Danilo: Erstellen von Methoden von UserStory Album
 * anlegen
 ...
 * @date 25.11.2015 by Danilo: Methoden getAlbumList und deleteListOfAlbum
 * ergänzt
...
public class AlbenController {
    ...
    /**
     * GUI-Methode Diese Methode erstellt im AlbumContainer ein Album mit Titel,
     * Beschreibung und Sortierkennzeichen
     *
     ...
     * @param sortierkennzeichen Sortierkennzeichen des Albums welches erstellt
     * werden soll
     * @return Fehlercode zur Auswertung
     *
     * Version-History:
     * @date 24.11.2015 by Danilo: Initialisierung
     * @date 25.11.2015 by Danilo: Initialisierung Stringprüfung und
     * Fehlerbehandlung
     * @date 29.11.2015 by Danilo: Fehlerkorrektur bei Fehler´haftenversuch ein
     * Album anzulegen
     * @date 01.12.2015 by Danilo: Fehlerkorrektur
     * @date 04.12.2015 by Danilo: Fehlerkorrektur bei zu kurzen Albentiteln
    ...
    /**
     * GUI-Methode Diese Methode verändert im AlbumContainer ein bestehendes
     * Album in Form von Titel, Beschreibung und Sortierkennzeichen
     *
    ...
    public static int editAlbum(String title, String newTitle, String beschreibung, int sortierkennzeichen) {
        // Prüft zu kruze Albentitel
        if (newTitle == null || newTitle.length() <= minTitleLength) {
            return ErrorController.addDebugReport(155);
        }
        if (beschreibung == null) {
            return ErrorController.addDebugReport(156);
        }
        ...
        if (editAlbumTitle(title, newTitle) != 0) {
            return ErrorController.addDebugReport(150);
        }
        if (editAlbumBeschreibung(newTitle, beschreibung) != 0) {
            return ErrorController.addDebugReport(160);
        }
        if (editAlbumSortierkennzeichen(newTitle, sortierkennzeichen) != 0) {
            return ErrorController.addDebugReport(170);
        }
     ...
     * @date 08.12.2015 by Danilo: Änderung des Fehlercodes und einfügen eines
     * Fehlerloggingsystemes
     */
     ...
     * @return Fehlercode zur Auswertung <br> 0 = Album wurde gelöscht <br> 1 =
     ...
     *
     * Version-History:
     * @return Fehlercode zur Auswertung <br> 0 = Albumtitel wurde geändert <br>
     * 1 = Album nicht vorhanden <br> 2 = neuer Albumtitel schon vorhanden
     * @date 21.11.2015 by Danilo: Initialisierung
     * @date 23.11.2015 by Danilo: Kommentar angepasst
     * @date 24.11.2015 by Danilo: Methode auf static gesetzt
     ...
     *
     * Version-History:
     * @return Fehlercode zur Auswertung <br> 0 = Albumbeschreibung wurde
     * geändert <br> 1 = Album nicht vorhanden
     * @date 21.11.2015 by Danilo: Initialisierung
     * @date 23.11.2015 by Danilo: Kommentar angepasst
     * @date 24.11.2015 by Danilo: Methode auf static gesetzt
     * @date 01.12.2015 by Danilo: Fehlerkorrektur
    ...
    /**
     * Diese Methode ändert im AlbumContainer das Sortierkennzeichen eines
     * Albums
     *
     * @param title Titel des Albums welches geändert werden soll
     * @param sortierkennzeichen Neues Sortierkennzeichen des Albums
     * @return Fehlercode zur Auswertung <br> 0 = Albumsortierkennzeichen wurde
     * geändert <br> 1 = Album nicht vorhanden
     *
     * Version-History:
     * @date 21.11.2015 by Danilo: Initialisierung
    ...
    /**
     * Diese Methode gibt das Sortierkennzeichen für ein Album zurück, damit es
     * richtig in der GUI angezeigt werden kann.
     *
