 ...
 *
 * Version-History:
 * @date 11.01.2016 by Benni: Umbenennung von Variblen, kommentierten Code
 * entfernt
 */
public class TestDocumizer {
    ...
    /**
     * Protokollierung Version-History:
     *
     * @param errorcode Übergabe des internen PM Fehlercodes - Auflösung des
     * Fehlercodes folgt automatisch, 0 kein interner Fehlercode
    ...
    /**
     * IntegrationTests wird verwendet für die Integrations der einzelnen
     * UseCases, bzw. der im Pflichtenheft beschriebenen Produktfunktion
     * Version-History:
     *
     * @date 03.12.2015 by Benni: Initialisiarung
