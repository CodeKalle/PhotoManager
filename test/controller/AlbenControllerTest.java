 ...
 * @date 03.12.2015 by Daniel: editAlbum, createNewAlbumIsExpectedAlbum,
 * deleteAlbum, deleteListOfAlbums, createNewAlbum hinzugefügt
 * @date 04.12.2015 by Danilo: Anpassung an geänderten AlbenController
 * @date 05.12.2015 by Danilo: Anpassung der Zeitausgabe bei garantierte
 * Albumanzahl
...
public class AlbenControllerTest {
     ...
     * @date 06.12.2015 by Danilo: prepareResourcesToTest in setUpClass
     * umwandeln
     * @date 07.12.2015 by Danilo: Sortierkennzeichen Datentyp zu int
     */
    @BeforeClass
    ...
    /**
     * Testet die Methode createNewAlbum der Klasse AlbenController. Testet, ob
     * ein Album angelegt wird.
     *
     * Version-History:
     *
     * @date 01.12.2015 by Daniel: Initialisierung
     * @date 04.12.2015 by Danilo: Anpassung auf neue Version des
     * AlbenControllers
     */
    @Test
    ...
    /**
     * Testet die Methode createNewAlbum der Klasse AlbenController. Testet, ob
     * ein zufälliges Album angelegt wird.
     *
     * Version-History:
     *
     * @date 04.12.2015 by Danilo: Initialisierung
    ...
    /**
     * Testet die Methode createNewAlbum der Klasse AlbenController. Testet, ob
     * ein Album mit leerem String angelegt wird.
     *
     * Version-History:
     *
     * @date 04.12.2015 by Danilo: Initialisierung
    ...
    /**
     * Testet die Methode createNewAlbum der Klasse AlbenController. Testet, ob
     * ein Album mit null String angelegt wird.
     *
     * Version-History:
     *
     * @date 04.12.2015 by Danilo: Initialisierung
    ...
    /**
     * Testet die Methode createNewAlbum der Klasse AlbenController. Testet, ob
     * ein Album mit zu langem Namen angelegt wird.
     *
     * Version-History:
     *
    ...
    /**
     * Testet die Methode editAlbum der Klasse AlbenController. Testet, ob das
     * editierte Album die neuen Attribute übernommen hat.
     *
     * Version-History:
     *
     * @date 01.12.2015 by Daniel: Initialisierung
    ...
    /**
     * Testet die Methode editAlbum der Klasse AlbenController. Testet, ob das
     * editierte Album leere Attribute übernommen hat, außer Titel.
     *
     * Version-History:
     *
     * @date 04.12.2015 by Danilo: Initialisierung
    ...
    /**
     * Testet die Methode editAlbum der Klasse AlbenController. Testet, ob das
     * editierte Album die null Attribute nicht übernommen hat.
     *
     * Version-History:
     *
     * @date 01.12.2015 by Daniel: Initialisierung
    ...
    /**
     * Testet die Methode getAlbum der Klasse AlbenController. Testet, ob ein
     * Album aus der Datenbank gelesen werden kann.
     *
     * Version-History:
     *
     * @date 01.12.2015 by Daniel: Initialisierung
    ...
    /**
     * Testet die Methode getAlbum der Klasse AlbenController. Testet,
     * Zeitverzögerung des lesens der Datenbank bei garantierter Albenanzahl.
     *
     * Version-History:
     *
     * @date 04.12.2015 by Danilo: Initialisierung
    ...
    /**
     * Testet die Methode deleteListOfAlbum der Klasse AlbenController. Testet,
     * ob die übergebene Albenliste aus dem AlbenContainer gelöscht wird.
     *
     * Version-History:
     *
     * @date 01.12.2015 by Daniel: Initialisierung
    ...
    public void testDeleteListOfAlbumSuccess() {
        ...
        for (int i = 0; i < randomAlbenCount; i++) {
            ...
            if (i % 2 == 0) {
                deleteList.add(tmpAlbenList.get(i));
            }
        }
    ...
    /**
     * Testet die Methode deleteListOfAlbum der Klasse AlbenController. Testet,
     * ob die übergebene Albenliste aus dem AlbenContainer mit garantierter
     * Albenanzahl gelöscht wird.
     *
     * Version-History:
     *
    ...
    /**
     * Testet die Methode deleteListOfAlbum der Klasse AlbenController. Testet,
     * ob die übergebene Albenliste aus dem AlbenContainer glöscht wird.
     *
     * Version-History:
     *
     * @date 04.12.2015 by Danilo: Initialisierung
    ...
    /**
     * Testet die Methode getAlbumList der Klasse AlbenController. Testet, ob
     * die Liste der Alben korrekt abgerufen wird.
     *
     * Version-History:
     *
     * @date 04.12.2015 by Danilo: Initialisierung
    ...
    /**
     * Testet die Methode getAlbumList der Klasse AlbenController. Testet, ob
     * die Liste der Alben bei garantierter Albananzahl korrekt abgerufen wird.
     *
     * Version-History:
     *
     * @date 05.12.2015 by Danilo: Initialisierung
    ...
    /**
     * Testet die Methode editAlbumSortierkennzeichen der Klasse
     * AlbenController. Testet, ob das Sortierkennzeichen verändert werden kann
     *
     * Version-History:
     *
     * @date 16.01.2016 by Daniel: Initialisierung, nicht existierende
     * Sortierkennzeichen übernehmen Standartwert
     */
    @Test
    ...
    /**
     * Testet die Methode getSortierkennzeichenFromAlbum der Klasse
     * AlbenController. Testet, ob das Sortierkennzeichen korrekt zurückgegeben
     * wird
     *
     * Version-History:
     *
