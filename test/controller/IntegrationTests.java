...
/**
 * @author Benni IntegrationTests wird verwendet für die Integrations der
 * einzelnen UseCases, bzw. der im Pflichtenheft beschriebenen Produktfunktion
 *
 * Version-History:
 * @date 03.12.2015 by Benni: Grundgerüst angefangen
 * @date 08.12.2015 by Danilo: Änderung des Pfades
 * @date 10.01.2016 by Benni: Abänderung der Testpfad Hinterlegung, Testpfad
 * dynamisch: Applikationsverzeichnis + "\test\testdaten"
 */
